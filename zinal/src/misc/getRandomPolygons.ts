...
function getRandomPoints(rows:number, columns:number, size:number, margin:number):Array<Array<IPoint2D>>
	{
...
function getRandomPolygons(rows:number, columns:number, size:number, margin:number):Array<Array<Array<IPoint2D>>>
	{
